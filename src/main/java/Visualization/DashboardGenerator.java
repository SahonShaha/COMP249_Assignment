...
/**
    ...
    private static void writeClientsTable(SmartTravelService service, PrintWriter out) {
        ...
        out.println("            <h2> Clients (" + validClientCount + ")</h2>");
        out.println("            <table>");
        out.println("                <thead>");
...
/**
    ...
    private static void writeTripsTable(SmartTravelService service, PrintWriter out) {
        out.println("        <section class='data-section'>");
        out.println("            <h2> Trips (" + validTripCount + ")</h2>");
        out.println("            <table>");
        out.println("                <thead>");
...
/**
    ...
    private static void writeStats(SmartTravelService service, PrintWriter out) {
        ...
        for (int i = 0; i < validTripCount; i++) {
            totalRevenue += SmartTravelService.calculateTripTotal(i);
        }

        double avgCost = totalRevenue/validTripCount;
        ...
        out.println("                    <span class='stat-value'>" + findMostVisitedDestination(service) + "<br><small>(" + countDestinationVisits(service, findMostVisitedDestination(service)) + " trips)</small></span>");
        out.println("                </div>");
